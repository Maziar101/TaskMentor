...
export const ACCENT_THEMES = {
  monochrome: {
    ...
    css: {
      "--tm-page-base": "#000000",
      "--tm-page-glow-primary": "rgba(255, 255, 255, 0)",
      "--tm-page-glow-secondary": "rgba(255, 255, 255, 0)",
      "--tm-surface-deep": "#000000",
      "--tm-surface-solid": "#0f0f0f",
      "--tm-surface-1": "#0f0f0f",
      "--tm-surface-2": "#000000",
      "--tm-surface-elevated": "#0f0f0f",
      "--tm-surface-elevated-strong": "#0f0f0f",
      "--tm-primary": "#ffffff",
      "--tm-primary-strong": "#ffffff",
      "--tm-accent": "#ffffff",
      "--tm-accent-strong": "#ffffff",
      "--tm-accent-tint": "rgba(255, 255, 255, 0.06)",
      "--tm-accent-soft": "rgba(255, 255, 255, 0.12)",
      "--tm-accent-border": "rgba(255, 255, 255, 0.48)",
      "--tm-accent-glow": "rgba(255, 255, 255, 0.18)",
      "--tm-on-accent": "#000000",
      "--tm-text": "#ffffff",
      "--tm-text-muted": "rgba(255, 255, 255, 0.68)",
      "--tm-text-accent": "#ffffff",
      "--tm-border-subtle": "rgba(255, 255, 255, 0.1)",
      "--tm-border-soft": "rgba(255, 255, 255, 0.18)",
      "--tm-border": "rgba(255, 255, 255, 0.28)",
      "--tm-border-strong": "rgba(255, 255, 255, 0.62)",
      "--tm-primary-soft": "rgba(255, 255, 255, 0.12)",
      "--tm-primary-tint": "rgba(255, 255, 255, 0.06)",
      "--tm-primary-glow": "rgba(255, 255, 255, 0.18)",
    },
  },
  red: {
    label: "قرمز",
