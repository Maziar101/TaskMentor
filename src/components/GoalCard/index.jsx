...
export default function GoalCard({ title, desc, due, status, impact, progress, }) {
    return (<article className="goal-card">
      ...
      <div className="progress">
        <span className={`progress__fill progress__fill--${status}`} style={progress === undefined ? undefined : { width: `${progress}%` }}/>
      </div>
    </article>);
}
